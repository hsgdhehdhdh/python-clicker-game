...
clicksPerClicks = int(f.readline())
f.close
root = Tk()
...
clickmee = Button(root, text='shop', command=lambda : shop())
clickmee.place(x=75, y=0)
clickmeee = Button(root, text='sell', command=lambda : sell())
clickmeee.place(x=150, y=0)
root.mainloop()
